...
/*
    if(substr($_SERVER['SCRIPT_NAME'],-13)=='/wp-login.php'&&empty($_COOKIE['wordpress_test_cookie']))
    {
      //binero_block_bad_request('Detected Wordpress bruteforce attack');
      ini_set('display_errors', '0');
      trigger_error($_SERVER['REMOTE_ADDR'].' attempted to login to WP without session cookie');
    }
*/
...
/*
  if($_SERVER['REQUEST_METHOD'] == 'GET' && empty($_COOKIE['binero_cookie']))
  {
    setcookie('binero_cookie', 1, 0, '/');
  }
*/
