<h1>Info</h1>
<h2>Kontakt</h2>
<div id="kontakt" class="lg-12 md-12 sm-12 xs-12">
<h3>Allmänna frågor:</h3>
    <p class="info-short"><a>kontakt@podcasts.nu</a></p>

<h3>Tips om nya podcasts, frågor om hemsidan:</h3>
    <p class="info-short"><a>daniel@podcasts.nu</a></p>


<h3>Frågor angående våra sociala medier</h3>
...
<p>Podcasts.nu! Vi finns till för att göra det enklare för dig att lyssna på dina nuvarande favorit-podcasts men också
    ...
    kända. Som icke inloggad besökare hjälper vi dig med att komma ihåg var i din befintliga spelning du är, så om du byter sida etc kommer vi ihåg var du var innan det bröts tack vare cookies, läs mer om cookies längst ner</p>
...
<p class="info-short">Fördelar som medlem</p>
    ...
    <p>Besök gärna "Min Sida" och upptäck det smidiga fördelarna med att vara medlem!</p>
    <p><a href="/sign-up" class="btn btn-primary btn-sm" role="button">Bli medlem</a></p>
</div>

<div id="anvandarvillkor">
...
<div id="cookies">
    <h2>Cookies</h2>
    En Cookie är en liten textfil som lagras i besökarens dator. Denna textfil kommer endast innehålla information för att underlätta
    för just ditt användande. Exempelvis var någonstans i ett avsnitt du är. För att vi på så sätt ska kunna erbjuda en bättre och mer
    lättanvänlig hemsida.
</div>